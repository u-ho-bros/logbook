    ...
    private static final Map<Integer, ItemDto> ITEM = new ConcurrentHashMap<Integer, ItemDto>() {
        {
            ...
            this.put(128, new ItemDto(128, 3, 3, 0, 0, 0, 30, -1, 1, 4, 0, "試製51cm連装砲", 0, 0, 0, 5,
                    0, 0, 0, 0, 0, 0, 5));
            this.put(129, new ItemDto(129, 39, 32, 0, 0, 0, 0, 3, 2, 0, 0, "熟練見張員", 0, 0, 0, 3,
                    0, 2, 0, 0, 0, 0, 1));
            this.put(130, new ItemDto(130, 4, 16, 0, 0, 0, 1, 1, 1, 1, 0, "12.7cm高角砲+高射装置", 0, 0, 0, 3,
                    0, 0, 0, 0, 0, 0, 8));
            this.put(131, new ItemDto(131, 21, 15, 0, 0, 0, 0, 1, 0, 0, 0, "25mm三連装機銃 集中配備", 0, 0, 0, 3,
                    0, 0, 0, 0, 0, 0, 9));
            this.put(132, new ItemDto(132, 40, 18, 0, 0, 0, 0, 1, 1, 0, 0, "零式水中聴音機", 0, 0, 0, 3,
                    0, 1, 0, 0, 0, 11, 0));
            this.put(133, new ItemDto(133, 3, 3, 0, 0, 0, 20, -1, -3, 4, 0, "381mm/50 三連装砲", 0, 0, 0, 4,
                    0, 0, 0, 0, 0, 0, 2));
            this.put(134, new ItemDto(134, 4, 4, 0, 0, 0, 8, 0, 1, 2, 0, "OTO 152mm三連装速射砲", 0, 0, 0, 3,
                    0, 0, 0, 1, 0, 0, 2));
            this.put(135, new ItemDto(135, 4, 16, 0, 0, 0, 1, 0, 1, 1, 0, "90mm単装高角砲", 0, 0, 0, 3,
                    0, 0, 0, 0, 0, 0, 8));
            this.put(136, new ItemDto(136, 28, 23, 0, 0, 0, 0, -1, 0, 0, 0, "プリエーゼ式水中防御隔壁", 0, 0, 0, 3,
                    0, 0, 0, 7, 0, 0, 0));
            this.put(137, new ItemDto(137, 3, 3, 0, 0, 0, 21, -1, -1, 4, 0, "381mm/50 三連装砲改", 0, 0, 0, 5,
                    0, 0, 0, 0, 0, 0, 4));
            this.put(138, new ItemDto(138, 41, 33, 0, 0, 0, 0, 0, 1, 0, 0, "二式大艇", 0, 0, 0, 4,
                    0, 12, 0, 0, 0, 1, 0));
            this.put(139, new ItemDto(139, 2, 2, 0, 0, 0, 5, 0, 4, 2, 0, "15.2cm連装砲改", 0, 0, 0, 3,
                    0, 0, 0, 0, 0, 0, 3));
            this.put(140, new ItemDto(140, 42, 24, 0, 0, 0, 0, 0, 0, 0, 0, "96式150cm探照灯", 0, 0, 0, 3,
                    0, 3, 0, 0, 0, 0, 1));
            this.put(141, new ItemDto(141, 13, 11, 0, 0, 0, 0, 0, 9, 0, 0, "32号対水上電探改", 0, 0, 0, 4,
                    0, 11, 0, 0, 0, 0, 0));
            ...
            this.put(551, new ItemDto(551, 3, 3, 0, 0, 0, 27, 0, 3, 3, 0, "20inch連装砲", 0, 0, 0, 4,
                    0, 0, 0, 0, 0, 0, 4));
            this.put(552, new ItemDto(552, 3, 3, 0, 0, 0, 13, 0, 4, 3, 0, "15inch要塞砲", 0, 0, 0, 2,
                    0, 0, 0, 3, 0, 0, 0));
        }
    };
